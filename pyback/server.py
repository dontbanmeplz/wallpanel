...
def generate_selfsigned_cert():
    try:
        OpenSslCommand = (
            ...
            + "cert.pem -keyout "
            + thisScriptPath
            + 'key.pem -subj "/C=IN/ST=Maharashtra/L=Satara/O=Wannabees/OU=KahiHiHa Department/CN=www.iamselfdepartment.com"'
        )
