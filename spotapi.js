!function e(t, n, r) {
    ...
    return s;
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.createPromiseResolver = function () {
            var e, t;
            return {promise: new Promise(function (n, r) {
                    e = n, t = r;
                }), resolve: e, reject: t};
        };
    }, {}], 2: [function (e, t, n) {
        (function (e) {
            (function () {
                ...
                !function (n) {
                    ...
                    function s(e, t) {
                        return e !== r && ("function" == typeof Object.create ? Object.defineProperty(e, "__esModule", {value: true}) : e.__esModule = true), function (n, r) {
                    ...
                    n = function (e, n) {
                        ...
                        var n, r, s, o, a = {label: 0, sent: function () {
                                if (1 & s[0]) throw s[1];
                                return s[1];
                            }, trys: [], ops: []};
                        return o = {next: i(0), throw: i(1), return: i(2)}, "function" == typeof Symbol && (o[Symbol.iterator] = function () {
                            return this;
                        }), o;
                        function i(o) {
                            return function (i) {
                        ...
                        undefined === r && (r = n), Object.defineProperty(e, r, {enumerable: true, get: function () {
                                return t[n];
                            }});
                    } : function (e, t, n, r) {
                        ...
                        try {
                            for (; (undefined === t || t-- > 0) && !(r = o.next()).done;) a.push(r.value);
                        } catch (e) {
                            s = {error: e};
                        } finally {
                            try {
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.AnthemEvents = undefined, function (e) {
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.Errors = undefined, function (e) {
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.Messages = undefined, function (e) {
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.PlayerError = undefined;
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.setupPlayerEnv = undefined;
        var r = e("tslib"), s = e("@js-sdk/common/lib/promise_resolver"), o = e("../enums/messages"), a = e("../enums/anthemEvents"), i = e("../enums/errors"), u = e("../error/player_error"), c = e("../shared/message_dispatcher"), f = e("../shared/messages_factory");
        n.setupPlayerEnv = function (e, t) {
            var n = "https://sdk.scdn.co/embedded/index.html", l = s.createPromiseResolver(), _ = c.MessageDispatcher.create(), p = t || function (t) {
            ...
            return function () {
                ...
                return t.prototype._getListeners = function (e) {
                    ...
                    if ("function" == typeof r) new Promise(r).then(function (e) {
                        console.log(f.messages.token(e, t))
                    ...
                    var t;
                    e.ref in this._connectionRequests && (null === (t = this._connectionRequests[e.ref]) || undefined === t || t.resolve(e.connected), delete this._connectionRequests[e.ref]);
                }, t.prototype._onCurrentState = function (e) {
                    var t;
                    e.ref in this._getCurrentStateRequests && (null === (t = this._getCurrentStateRequests[e.ref]) || undefined === t || t.resolve(e.state), delete this._getCurrentStateRequests[e.ref]);
                }, t.prototype._onVolume = function (e) {
                    var t;
                    e.ref in this._getVolumeRequests && (null === (t = this._getVolumeRequests[e.ref]) || undefined === t || t.resolve(e.volume), delete this._getVolumeRequests[e.ref]);
                }, t.prototype._handleMessages = function (e, t, n) {
                    var r, s;
                    null === (s = (r = this._messageHandlers)[e]) || undefined === s || s.call(r, t, n);
                    ...
                    return this.isLoaded.then(function () {
                        ...
                        return e._connectionRequests[n] = s.createPromiseResolver(), null === (t = e._connectionRequests[n]) || undefined === t ? undefined : t.promise;
                    });
                }, t.prototype.on = function (e, t) {
                    return -1 === this._eventListeners[e].indexOf(t) && (this._eventListeners[e].push(t), true);
                }, t.prototype.addListener = function (e, t) {
                    return this.on(e, t);
                }, t.prototype.removeListener = function (e, t) {
                    var n = this._eventListeners[e];
                    return 1 === arguments.length ? (this._eventListeners[e] = [], true) : !(!n || !n.length) && (this._eventListeners[e] = n.filter(function (e) {
                        return e !== t;
                    }), true);
                    ...
                    return this.isLoaded.then(function () {
                        ...
                        return e._getCurrentStateRequests[n] = s.createPromiseResolver(), null === (t = e._getCurrentStateRequests[n]) || undefined === t ? undefined : t.promise;
                    });
                }, t.prototype.getVolume = function () {
                    var e = this;
                    return this.isLoaded.then(function () {
                        var t, n = e._sendMessage(f.messages.getVolume());
                        return e._getVolumeRequests[n] = s.createPromiseResolver(), null === (t = e._getVolumeRequests[n]) || undefined === t ? undefined : t.promise;
                    });
    ...
    }, {"../enums/anthemEvents": 3, "../enums/errors": 4, "../enums/messages": 5, "../error/player_error": 6, "../shared/message_dispatcher": 9, "../shared/messages_factory": 10, "@js-sdk/common/lib/promise_resolver": 1, tslib: 2}], 9: [function (e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.MessageDispatcher = undefined;
        var r = e("../enums/messages"), s = function () {
            ...
            return e.create = function () {
                ...
                if (e.data) {
                    ...
                    n === r.Messages.SPOTIFY_MESSAGE && (null == s ? undefined : s.topic) && this._onMessageCallback(s.topic, s.data, o);
                }
        ...
        "use strict";
        Object.defineProperty(n, "__esModule", {value: true}), n.messages = undefined;
        var r = e("../enums/messages"), s = function () {
            function e() {}
            return e.create = function () {
                return new e;
                ...
                return {type: r.Messages.SPOTIFY_MESSAGE, body: {topic: e, data: undefined !== t ? JSON.parse(JSON.stringify(t)) : undefined}};
