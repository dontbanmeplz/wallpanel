					...
					return (function () {
						function t(t) {
							...
							;(this._options = {
								name:
									t.name ||
									(null === (s = null == e ? undefined : e.location) ||
									undefined === s
										? undefined
										: s.hostname) ||
									"",
								getOAuthToken: t.getOAuthToken || t.getOauthToken,
								volume: null !== (i = t.volume) && undefined !== i ? i : 1,
						...
						return (
							...
							(t.prototype.connect = function () {
								...
								return this.isLoaded.then(function () {
									...
									return (
										...
										null === (t = e._connectionRequests[n]) || undefined === t
											? undefined
											: t.promise
									)
								})
							...
							(t.prototype.on = function (e, t) {
								return (
									...
									(this._eventListeners[e].push(t), true)
								)
							}),
							...
							(t.prototype.getCurrentState = function () {
								...
								return this.isLoaded.then(function () {
									...
									return (
										...
										null === (t = e._getCurrentStateRequests[n]) ||
										undefined === t
											? undefined
											: t.promise
									)
							...
							(t.prototype.getVolume = function () {
								...
								return this.isLoaded.then(function () {
									...
									return (
										...
										null === (t = e._getVolumeRequests[n]) || undefined === t
											? undefined
											: t.promise
									)
								})
